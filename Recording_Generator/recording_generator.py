...
recording_path = 'data/tetrode_10.h5'
...
recordings_params['recordings']['noise_level'] = 20
...
#recording generation and check
recgen = mr.gen_recordings(templates=template_path, params=recordings_params)
...
if save_flag == 1:
    mr.save_recording_generator(recgen=recgen, filename=recording_path)